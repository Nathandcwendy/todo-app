...
const FilterOptionsMob = ({ setFilter, filter }) => {
  ...
  return (
    <div className="flex space-x-4 xs:hidden text-base text-slate-500 flex-row justify-center items-center w-full px-4 py-4 bg-white dark:bg-dm-VDDesatBlue rounded-lg mt-4">
      <p
        className={
          filter === "all"
